...
int main() {
    ...
    if (choice == 1) {
        ...
        char transform;
        cout << "Apply transformations? (y/n): ";
        cin >> transform;
        ...
        cout << "Enter coordinates of first vertex (x y z): ";
        cin >> x1 >> y1 >> z1;
        cout << "Enter coordinates of second vertex (x y z): ";
        cin >> x2 >> y2 >> z2;
        cout << "Enter coordinates of third vertex (x y z): ";
        cin >> x3 >> y3 >> z3;
